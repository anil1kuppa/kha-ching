...
import { getAllOrNoneCompletedOrdersByKiteResponse, getPercentageChange } from "../../utils"
...
async function optionSellerOptionEntry({ initialJobData, optionStrike }) {
  ...
  const { order_id: limitOrderAckId } = await placeOrder(kite, kite.VARIETY_REGULAR, order)
